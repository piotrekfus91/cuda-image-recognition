...
class GpuUnionFindSegmentatorTest : public ::testing::Test {
protected:
...
void GpuUnionFindSegmentatorTest::SetUp() {
	_logger = new NullLogger;
	_service = new GpuImageProcessingService(*_logger);
	_service->setSegmentator(new GpuUnionFindSegmentator);
	_service->setSegmentatorMinSize(0);
}

void GpuUnionFindSegmentatorTest::TearDown() {
	delete _logger;
	delete _service;
}

TEST_F(GpuUnionFindSegmentatorTest, Sample) {
...
TEST_F(GpuUnionFindSegmentatorTest, Sample2) {
...
TEST_F(GpuUnionFindSegmentatorTest, Sample9x11) {
...
void compare_using_gpu_union_find_and_splitting(const char* fileName, GpuImageProcessingService* _service, Logger* _logger) {
...
TEST_F(GpuUnionFindSegmentatorTest, Metro) {
	compare_using_gpu_union_find_and_splitting("metro_red_yellow.bmp", _service, _logger);
}
